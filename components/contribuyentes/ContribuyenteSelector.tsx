...
export function ContribuyenteSelector() {
  ...
  const canCreate = allTaxpayerProfiles.length < 3
  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span className="text-primary-400 text-[10px]">{allTaxpayerProfiles.length}/3</span>
        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-1.5 w-64 bg-white rounded-xl shadow-xl border border-slate-100 z-20 overflow-hidden">
            <div className="px-3 py-2 border-b border-slate-100 bg-slate-50">
              ...
              <p className="text-[10px] text-slate-400 mt-0.5">Podés tener hasta 3 para practicar distintos regímenes</p>
            </div>
            ...
            {!canCreate && (
              <div className="border-t border-slate-100 px-4 py-2">
                <p className="text-[10px] text-slate-400 text-center">Límite alcanzado: 3/3 contribuyentes</p>
              </div>
            )}
